...
test('all requests target the production webhook with JSON bodies', () => {
...
test('collection contains only synthetic example.com identities and no secrets', () => {
  const serialized = JSON.stringify(collection);
  assert.doesNotMatch(serialized, /api_access_token|authorization|bearer|CHATWOOT_API_ACCESS_TOKEN/i);
